...
package com.mirzaadil.cyberinov8.searchbar.utils;
...
import static com.mirzaadil.cyberinov8.searchbar.utils.RxSuggestionsInternal.SEARCH_TERM_TO_URL_MAPPER;
import static com.mirzaadil.cyberinov8.searchbar.utils.RxSuggestionsInternal.emptyStringFilter;
import static com.mirzaadil.cyberinov8.searchbar.utils.RxSuggestionsInternal.requireNonNull;

public class RxSuggestions {
    private static final String TAG = RxSuggestions.class.getSimpleName();
    private static final int DEFAULT_NO_SUGGESTIONS = 10;
